App = {
    ...
    App.contracts.Election.deployed().then(function(instance) {
      ...
      for (var i = 1; i <= candidatesCount; i++) {
        electionInstance.candidates(i).then(function(candidate) {
          ...
          var candidateTemplate = "<tr><th>" + id + "</th><td>" + name + "</td><td>" + voteCount + "</td><td><button type='button' class='btn btn-success' data-toggle='modal' data-target='#myModal'>Offer</button></td></tr>"
  ...
  renderFeedMe: function() {
    ...
    App.contracts.FeedMe.deployed().then(function(instance) {
      ...
      // for (var i = 1; i <= candidatesCount; i++) {
      //   feedmeInstance.candidates(i).then(function(candidate) {
      //     var id = candidate[0];
      //     var name = candidate[1];
      //     var voteCount = candidate[2];
      ...
      //   });
      // }
      // return feedmeInstance.voters(App.account);
    }).catch(function(error) {
      console.warn(error);
    });
